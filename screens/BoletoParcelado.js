...
const BoletoParcelado = ({ route, navigation }) => {
    useLogScreen('BoletoParcelado');
                    ...
                    <ScrollView contentContainerStyle={styles.scrollContainer}>
                        <View style={styles.container}>
                            ...
                            <View style={styles.row}>
                                <Text style={styles.checkboxLabel} allowFontScaling={false}>Parcele o pagamento de qualquer boleto usando o limite do seu cartão de crédito! É rápido, seguro e você ainda acumula pontos nos programas da sua operadora de cartão de crédito!</Text>
                            </View>
                            ...
                            <View style={styles.row}>
                                ...
                                <View style={styles.optionButtonsContainer}>
                                    <TouchableOpacity style={styles.optionButton} onPress={() => {
                                        ...
                                        <Image
                                            source={require('../assets/icons/2perfil.png')} // Ícone de "Carregar um arquivo"
                                            style={styles.optionIcon}
                                        />
                                        <View style={styles.optionTextContainer}>
                                            <Text style={styles.optionTextTitle} allowFontScaling={false}>Comissão de corretagem</Text>
                                        </View>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.optionButton} onPress={() => {
                                        Linking.openURL('');
                                        ...
                                        <Image
                                            source={require('../assets/icons/avaliador-roxo.png')} // Ícone de "Carregar um arquivo"
                                            style={styles.optionIcon}
                                        />
                                        <View style={styles.optionTextContainer}>
                                            <Text style={styles.optionTextTitle} allowFontScaling={false}>Sinal</Text>
                                        </View>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.optionButton} onPress={() => {
                                        Linking.openURL('');
                                        ...
                                        <Image
                                            source={require('../assets/icons/home.png')} // Ícone de "Carregar um arquivo"
                                            style={styles.optionIcon}
                                        />
                                        <View style={styles.optionTextContainer}>
                                            <Text style={styles.optionTextTitle} allowFontScaling={false}>IPTU/ITBI/ITCMD</Text>
                                        </View>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.optionButton} onPress={() => {
                                        Linking.openURL('');
                                        ...
                                        />
                                        <View style={styles.optionTextContainer}>
                                            <Text style={styles.optionTextTitle} allowFontScaling={false}>Aluguel / Condomínio</Text>
                                            {/* Escrituras e Registro de imóvel */}
                                        </View>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.optionButton} onPress={() => {
                                        Linking.openURL('');
                                        ...
                                        />
                                        <View style={styles.optionTextContainer}>
                                            <Text style={styles.optionTextTitle} allowFontScaling={false}>Outros</Text>
                                        </View>
                                    </TouchableOpacity>
                                </View>
                            </View>
...
export default BoletoParcelado;
