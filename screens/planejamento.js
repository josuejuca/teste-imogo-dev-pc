...
const PlanejamentoRedes = ({ route, navigation }) => {
    const { id, usuario_id, tipo_documento, status_user } = route.params || {};
    useLogScreen('PlanejamentoRedes');
                            ...
                            <View style={styles.row}>
                                ...
                                <View style={styles.optionButtonsContainer}>
                                    <TouchableOpacity style={styles.optionButton} onPress={() => {
                                        Linking.openURL('https://cdn.imogo.com.br/manuais/dando_os_primeiros_passos.pdf');
                                    }}>
                                        <Image
                                            source={require('../assets/icons/download.png')} // Ícone de "Carregar um arquivo"
                                            style={styles.optionIcon}
                                        />
                                        <View style={styles.optionTextContainer}>
                                            <Text style={styles.optionTextTitle} allowFontScaling={false}>Dando os primeiros passos</Text>
                                            <Text style={styles.optionTextSubtitle} allowFontScaling={false}>Baixe o pdf</Text>
                                        </View>
                                    </TouchableOpacity>

                                    <TouchableOpacity style={styles.optionButton} onPress={() => {
                                        Linking.openURL('https://juk.re/cronograma-postagem');
                                    }}>
                                        <Image
                                            source={require('../assets/icons/download.png')} // Ícone de "Carregar um arquivo"
                                            style={styles.optionIcon}
                                        />
                                        <View style={styles.optionTextContainer}>
                                            <Text style={styles.optionTextTitle} allowFontScaling={false}>Planilha de cronograma de postagens</Text>
                                            <Text style={styles.optionTextSubtitle} allowFontScaling={false}>Baixe a planilha de cronograma</Text>
                                        </View>
                                    </TouchableOpacity>

                                    <TouchableOpacity style={styles.optionButton} onPress={() => {
                                        Linking.openURL('https://www.canva.com/design/DAGdnOpmQEM/LIuZfAtKG-HtZ_u2ean2LA/view?utm_content=DAGdnOpmQEM&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=hdbb9cdba40');
                                    }}>
                                        <Image
                                            source={require('../assets/icons/download.png')} // Ícone de "Carregar um arquivo"
                                            style={styles.optionIcon}
                                        />
                                        <View style={styles.optionTextContainer}>
                                            <Text style={styles.optionTextTitle} allowFontScaling={false}>Modelo de card no canva</Text>
                                            <Text style={styles.optionTextSubtitle} allowFontScaling={false}>Acesse a pasta no canva</Text>
                                        </View>
                                    </TouchableOpacity>
                                </View>
                            </View>
...
export default PlanejamentoRedes;