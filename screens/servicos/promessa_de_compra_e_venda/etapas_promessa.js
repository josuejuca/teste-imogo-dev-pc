...
const EtapasPromessa = ({ route, navigation }) => {
    useLogScreen('EtapasPromessa');
    const {
        status = 1,
        usuario_id,      
        email_solicitante,
    ...
    console.log('payload_vendedores:', payload_vendedores);
    console.log('payload_compradores:', payload_compradores);
    console.log('payload_imovel_one:', payload_imovel_one);
    const steps = [
        { label: 'Dados do(s) vendedor(es)', status: 1, view: 'DadosVendedores' },
        { label: 'Dados do(s) comprador(es)', status: 2, view: 'DadosComprador' },
        { label: 'Dados do imóvel', status: 3, view: 'DadosImovelPromessa' },
        { label: 'Dados da  negociação', status: 4, view: 'DadosImovel' },
        // { label: 'Dados das testemunhas', status: 4, view: 'DadosTestemunhas' },
        { label: 'Dados das testemunhas', status: 5, view: 'DadosTestemunhas' },
    ];
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.headerTitle} allowFontScaling={false}>Promessa de Compra e Venda</Text>
            </View>
            <View style={styles.container}>
                <View style={styles.row}>
                    ...
                    <Text style={styles.checkboxLabel} allowFontScaling={false}>Complete todas as etapas para gerar o contrato particular de promessa de compra e venda de imóvel.</Text>
                </View>
